...
function _pawnPath(ctx) {
  // Round head, narrow neck, smooth bell-flare body, broad flat base with gentle wave.
  ctx.moveTo(0, -30);
  ctx.bezierCurveTo(5.8, -30, 8.5, -27.2, 8.5, -22);
  ctx.bezierCurveTo(8.5, -17, 6, -14, 3.5, -14);
  ctx.bezierCurveTo(4, -10.5, 4.2, -6.5, 4.4, -2.5);
  ctx.bezierCurveTo(5.8, 2, 10, 6.5, 13, 11);
  ctx.bezierCurveTo(14.5, 13, 15.3, 14.5, 15, 16);
  ctx.bezierCurveTo(15.5, 16.8, 14.5, 17.8, 13, 18);
  ctx.bezierCurveTo(7, 18.8, -7, 18.8, -13, 18);
  ctx.bezierCurveTo(-14.5, 17.8, -15.5, 16.8, -15, 16);
  ctx.bezierCurveTo(-15.3, 14.5, -14.5, 13, -13, 11);
  ctx.bezierCurveTo(-10, 6.5, -5.8, 2, -4.4, -2.5);
  ctx.bezierCurveTo(-4.2, -6.5, -4, -10.5, -3.5, -14);
  ctx.bezierCurveTo(-6, -14, -8.5, -17, -8.5, -22);
  ctx.bezierCurveTo(-8.5, -27.2, -5.8, -30, 0, -30);
  ctx.closePath();
}

function _knightPath(ctx) {
  // Right-facing horse head: ear spike, angular muzzle, thick sweeping neck,
  // two-step rectangular pedestal base.
  ctx.moveTo(-2, -30);
  ctx.lineTo(-5, -25);
  ctx.bezierCurveTo(-9, -24, -12, -22, -14, -17);
  ctx.bezierCurveTo(-14, -12, -13, -7, -11, -3);
  ctx.lineTo(-11, 3);
  ctx.lineTo(-14, 3);
  ctx.lineTo(-14, 8);
  ctx.lineTo(-16, 8);
  ...
  ctx.lineTo(14, 3);
  ctx.lineTo(8, 3);
  ctx.bezierCurveTo(8, 0, 7, -4, 7, -7);
  ctx.lineTo(10, -7);
  ctx.lineTo(10, -10);
  ctx.bezierCurveTo(15, -11, 17, -13, 17, -15);
  ctx.lineTo(15, -16);
  ctx.bezierCurveTo(11, -18, 7, -19, 4, -22);
  ctx.bezierCurveTo(3, -24, 1, -27, 0, -28);
  ctx.lineTo(-2, -30);
  ctx.closePath();
}

function _bishopPath(ctx) {
  // Tall narrow piece: rounded mitre with finial, long elegant neck, wide flat base with one step.
  ctx.moveTo(0, -34);
  ctx.bezierCurveTo(3, -34, 3.5, -32, 2, -30);
  ctx.bezierCurveTo(7, -28, 9, -22, 9, -16);
  ctx.lineTo(10, -15);
  ctx.lineTo(10, -12);
  ctx.lineTo(5, -12);
  ctx.bezierCurveTo(5.5, -7, 6.5, -2, 7, 2);
  ctx.bezierCurveTo(9, 6, 12, 10, 14, 13);
  ctx.lineTo(15, 13);
  ctx.lineTo(15, 16);
  ctx.lineTo(17, 16);
  ctx.lineTo(17, 19);
  ...
  ctx.lineTo(-15, 13);
  ctx.lineTo(-14, 13);
  ctx.bezierCurveTo(-12, 10, -9, 6, -7, 2);
  ctx.bezierCurveTo(-6.5, -2, -5.5, -7, -5, -12);
  ctx.lineTo(-10, -12);
  ctx.lineTo(-10, -15);
  ctx.lineTo(-9, -16);
  ctx.bezierCurveTo(-9, -22, -7, -28, -2, -30);
  ctx.bezierCurveTo(-3.5, -32, -3, -34, 0, -34);
  ctx.closePath();
}

function _rookPath(ctx) {
  // Flat-topped tower: 3 battlements with 2 notches, body tapers inward at middle,
  // wide stepped base with rounded bottom step.
  ctx.moveTo(-15, -30);
  ctx.lineTo(-7, -30);
  ctx.lineTo(-7, -23);
  ctx.lineTo(-3, -23);
  ...
  ctx.lineTo(15, -30);
  ctx.lineTo(15, -18);
  ctx.bezierCurveTo(13, -15, 11, -10, 10, -5);
  ctx.bezierCurveTo(9.5, 0, 10, 5, 11, 9);
  ctx.bezierCurveTo(12, 11, 13, 13, 14, 14);
  ctx.lineTo(16, 14);
  ctx.lineTo(16, 16);
  ctx.bezierCurveTo(18, 16.5, 18, 19, 16, 19.5);
  ctx.bezierCurveTo(5, 20.3, -5, 20.3, -16, 19.5);
  ctx.bezierCurveTo(-18, 19, -18, 16.5, -16, 16);
  ctx.lineTo(-16, 14);
  ctx.lineTo(-14, 14);
  ctx.bezierCurveTo(-13, 13, -12, 11, -11, 9);
  ctx.bezierCurveTo(-10, 5, -9.5, 0, -10, -5);
  ctx.bezierCurveTo(-11, -10, -13, -15, -15, -18);
  ctx.lineTo(-15, -30);
  ctx.closePath();
}
